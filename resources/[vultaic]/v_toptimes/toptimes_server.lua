...
function()
	local db = exports.v_config:getDatabaseConfig("toptimes")
	toptimes.connection = dbConnect("mysql", "dbname="..db.database..";host="..db.host..";port="..db.port..";charset=utf8mb4", db.user, db.password, "share=1")
